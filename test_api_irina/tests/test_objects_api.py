...
class TestObjectsAPI:
    ...
    @pytest.fixture()
    def created_object_id(self, base_url):
        ...
        return post_object.response.json()['id']
    ...
    def test_update_object_put(self, base_url, created_object_id):
        ...
        put_object.put_object(created_object_id, {
            "name": "Updated Object",
            "data": {
