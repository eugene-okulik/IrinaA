...
# Фикстура для настройки и завершения тестирования
...
# Фикстура для создания объекта перед каждым тестом и его удаления после
@pytest.fixture()
...
@pytest.mark.story("CRUD Operations")
...
def test_update_object_patch(created_object_id):
    ...
    assert json_data['data']['attribute2'] == "patched_value2", \
        "Значение атрибута attribute2 после обновления"
