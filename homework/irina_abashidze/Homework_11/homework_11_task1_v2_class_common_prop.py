class Book:
    material = "бумага"  # Общее свойство класса - материал для всех экземпляров
    has_text = True  # Общее свойство класса - наличие текста для всех экземпляров
...
book1 = Book("Идиот", "Достоевский", 500, "123456789", True)
book2 = Book("Над пропастью во ржи", "Сэлинджер", 400, "987654321", False)
book3 = Book("Унесенные ветром", "Митчелл", 600, "111222333", False)
book4 = Book("Три мушкетера", "Дюма", 700, "444555666", False)
book5 = Book("Приключения Оливера Твиста", "Диккенс", 450, "777888999", False)

# Помечаем одну книгу как зарезервированную
book1.reserved = True

# Создаем экземпляры учебников
textbook1 = Textbook("Алгебра", "Иванов", 200, "111", "Математика", 9, True)
textbook2 = Textbook("Геометрия", "Мерзляк", 250, "222", "Математика", 10, True)
textbook3 = Textbook("Физика", "Генденштейн", 300, "333", "Физика", 11, True)
textbook4 = Textbook("История Украины", "Панчук", 150, "444", "История", 8, False)
textbook5 = Textbook("География", "Бойко", 180, "555", "География", 9, False)
